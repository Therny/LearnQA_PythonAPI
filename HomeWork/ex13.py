...
#            print(parsed_response["platform"])

            assert parsed_response["platform"] == value["platform"], f"Responce platform {parsed_response['platform']} not value {value}"
            assert parsed_response["browser"] == value["browser"], f"Responce browser {parsed_response['browser']} not value {value}"
            assert parsed_response["device"] == value["device"], f"Responce device {parsed_response['device']} not value {value}"
